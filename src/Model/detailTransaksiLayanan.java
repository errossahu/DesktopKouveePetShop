 ...
 * @author ACER
 */
public class detailTransaksiLayanan {
    ...
    public detailTransaksiLayanan(String id_detail , String id_trasaksi , int id_produk , int jum , int totalHarga, String created_By ,String created_at,String modified_by, String modified_at)
    {
        this.id_Detail_Transaksi = id_detail ;
        this.id_transaksi = id_trasaksi ;
        this.id_harga_layanan = id_produk ;
        this.Jumlah = jum ;
    ...
    public  void setId_Layanan(int id)
    {
        this.id_harga_layanan = id ;
    }
    public int  getId_hargaLayanan ()
    {
